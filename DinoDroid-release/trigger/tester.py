...
def main(options, args):
	...
	crashStr=options.crashStr

	#crashSet=set(crashStr.split("***"))
	...
	if policy == 'broadcast':
		...
		if len(activities) > 0:
			...
			print("tagAAA:"+selected+"endAAA")

			if not selected in crashStr:
...
if __name__ == '__main__':
	...
	parser.add_option('-c', '--crashStr', dest='crashStr', help='Specify the file path of the apk')
