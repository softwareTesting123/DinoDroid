        ...
        with self.session.as_default():
            with self.graph.as_default():
                for lastFeatureTuple, action, reward, featureTuple in minibatch0:
                    ...
                    if i==1:
                        outputFile = open("./trainResult/"+recordNameCrash+"_trainRecord_"+str(iteTime)+".txt", 'a')
                    else:
                        outputFile = open("./trainResult/"+recordNameCrash+"_trainRecordOther_"+str(iteTime)+".txt", 'a')
